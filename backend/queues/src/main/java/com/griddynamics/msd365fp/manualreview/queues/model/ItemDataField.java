...
public enum ItemDataField implements Serializable {
    ...
    LIFE_TIME_TRANSACTION_COUNT("purchase.CalculatedFields.transactionCount.lifetime"),
    ...
    LIFE_TIME_SUCCESSFUL_TRANSACTION_COUNT("purchase.CalculatedFields.successfulTransactionCount.lifetime"),
    ...
    LIFE_TIME_REJECTED_TRANSACTION_COUNT("purchase.CalculatedFields.rejectedTransactionCount.lifetime"),
    ...
    LIFE_TIME_FAILED_TRANSACTION_COUNT("purchase.CalculatedFields.failedTransactionCount.lifetime"),
    ...
    LIFE_TIME_TRANSACTION_AMOUNT("purchase.CalculatedFields.transactionAmount.lifetime"),
    LAST_HOUR_SUCCESSFUL_TRANSACTION_AMOUNT("purchase.CalculatedFields.successfulTransactionAmount.hour"),
    LAST_DAY_SUCCESSFUL_TRANSACTION_AMOUNT("purchase.CalculatedFields.successfulTransactionAmount.day"),
    LAST_WEEK_SUCCESSFUL_TRANSACTION_AMOUNT("purchase.CalculatedFields.successfulTransactionAmount.week"),
    LIFE_TIME_SUCCESSFUL_TRANSACTION_AMOUNT("purchase.CalculatedFields.successfulTransactionAmount.lifetime"),
    ...
    LIFE_TIME_REJECTED_TRANSACTION_AMOUNT("purchase.CalculatedFields.rejectedTransactionAmount.lifetime"),
    ...
    LIFE_TIME_FAILED_TRANSACTION_AMOUNT("purchase.CalculatedFields.failedTransactionAmount.lifetime"),
    ...
    LIFE_TIME_UNIQUE_PI("purchase.CalculatedFields.uniquePaymentInstrumentCount.lifetime"),
    ...
    LIFE_TIME_TRANSACTION_COUNT_CURRENT_PI("purchase.CalculatedFields.currentPaymentInstrumentTransactionCount.lifetime"),
    ...
    LIFE_TIME_TRANSACTION_AMOUNT_CURRENT_PI("purchase.CalculatedFields.currentPaymentInstrumentTransactionAmount.lifetime"),
    ...
    LIFE_TIME_UNIQUE_IP_COUNTRIES("purchase.CalculatedFields.uniqueIPCountries.lifetime");
