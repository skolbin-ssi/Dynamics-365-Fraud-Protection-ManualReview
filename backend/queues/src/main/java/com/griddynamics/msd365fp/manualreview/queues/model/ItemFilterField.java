...
public enum ItemFilterField implements Serializable {
    ...
    USER_COUNTRY("Account", "User country",
            ...
            Set.of(IN, NOT_IN, CONTAINS, REGEXP, BETWEEN_ALPH, NOT_BETWEEN_ALPH, EQUAL_ALPH, NOT_EQUAL_ALPH, LESS_ALPH, GREATER_ALPH, LESS_OR_EQUAL_ALPH, GREATER_OR_EQUAL_ALPH),
            null, null,
