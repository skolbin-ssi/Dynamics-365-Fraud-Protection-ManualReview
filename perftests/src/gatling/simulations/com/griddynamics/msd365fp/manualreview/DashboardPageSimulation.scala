...
import com.griddynamics.msd365fp.manualreview.action.OpenDashboardViewWithFrontend
import io.gatling.core.Predef._
import io.gatling.http.Predef._

class DashboardPageSimulation extends Simulation {
  ...
  val scn = scenario("DashboardPageSimulation")
    ...
    .repeat(10) {
      exec(OpenDashboardViewWithFrontend.action)
    }
