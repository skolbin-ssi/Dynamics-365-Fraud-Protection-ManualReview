...
import com.griddynamics.msd365fp.manualreview.action.OpenItemViewWithFrontend
import io.gatling.core.Predef._
import io.gatling.http.Predef._

class ItemPageSimulation extends Simulation {
  ...
  val scn = scenario("RecordedSimulation")
    ...
    .exec(OpenItemViewWithFrontend.action)
